...
* Fix: Removed cdn.hntgaming.me preload — filename is per-publisher, preconnect is sufficient
* Fix: Removed gtag.js preload — requires ?id= parameter, bare URL causes "preloaded but not used" warning
* Kept: GPT gpt.js preload (fixed URL, always loaded on ad-tech sites)
* Kept: Preconnect to cdn.hntgaming.me without crossorigin (connection warm, Referer header preserved)
...
* New: Preload gpt.js (GPT) for fastest ad initialization
