...
class HTG_Sidebar_Posts extends WP_Widget {
...
function HTG_register_sidebar_posts() {
    register_widget( 'HTG_Sidebar_Posts' );
}
add_action( 'widgets_init', 'HTG_register_sidebar_posts' );