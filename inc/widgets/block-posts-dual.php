...
class HTG_Dual_Category_Posts extends WP_Widget {
...
?>
                            ...
                            <?php if ( has_post_thumbnail() ) { ?>
                                <div class="hms-thumb">
                                    <a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>">	
                                        <?php the_post_thumbnail( 'HTG-thumbnail' ); ?>
                                    </a>
                                </div>
                            <?php } ?>
		...
		<div class="hm-dualc-right">
			<?php 
				...
				HTG_viewall_link( $category2, $viewall_text2 );
			?>
...
// register HTG dual category posts widget
function HTG_register_dual_category_posts() {
    register_widget( 'HTG_Dual_Category_Posts' );
}
add_action( 'widgets_init', 'HTG_register_dual_category_posts' );