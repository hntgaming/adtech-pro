...
class HTG_Single_Category_Posts extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		HTG_viewall_link( $category, $viewall_text );
		
		?>

		<div class="HTG-one-category">
			<?php $hmp_count = 1 ?>
			<?php 
				...
				while ( $latest_posts -> have_posts() ) : $latest_posts -> the_post();
					...
					<div class="hmb-post">
						...
						<?php if ( has_post_thumbnail() ) { ?>
							<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_post_thumbnail( 'HTG-grid' ); ?></a>
						<?php } ?>
...
function HTG_register_single_category_posts() {
    register_widget( 'HTG_Single_Category_Posts' );
}
add_action( 'widgets_init', 'HTG_register_single_category_posts' );