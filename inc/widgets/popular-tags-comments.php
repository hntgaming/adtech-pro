 ...
 */
class HTG_Tabbed_Widget extends WP_Widget {
					...
					while( $popular-> have_posts() ) : $popular->the_post(); ?>
						<div class="hms-post">
							<?php if ( has_post_thumbnail() ) { ?>
								<div class="hms-thumb">
									<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_post_thumbnail( 'HTG-thumbnail' ); ?></a>
								</div>
							<?php } ?>
						...
						foreach ( $comments as $comment ) { ?>
							<div class="hmw-comment">
								...
								<div class="hmw-comm-content">
									<a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>">
										<span class="hmw-comment-author"><?php echo esc_html( get_comment_author( $comment->comment_ID ) ); ?> </span> - <span class="HTG_comment_post"><?php echo esc_html( get_the_title($comment->comment_post_ID) ); ?></span>
									</a>
									<p class="hmw-comment">
...
//Registster HTG tabbed widget.
function HTG_register_tabbed_widget() {
    register_widget( 'HTG_Tabbed_Widget' );
}
add_action( 'widgets_init', 'HTG_register_tabbed_widget' ); 