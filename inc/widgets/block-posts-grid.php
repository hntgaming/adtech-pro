...
class HTG_Grid_Category_Posts extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<div class="HTG-grid-category-posts">
...
function HTG_register_grid_category_posts() {
    register_widget( 'HTG_Grid_Category_Posts' );
}
add_action( 'widgets_init', 'HTG_register_grid_category_posts' );