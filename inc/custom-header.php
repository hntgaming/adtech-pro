 ...
 *
 * @uses HTG_header_style()
 */
function HTG_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'HTG_custom_header_args', array(
		'default-image'          	=> '',
		...
		'flex-width'				=> true,
		'flex-height'				=> true,
		'wp-head-callback'       	=> 'HTG_header_style',
	) ) );
}
add_action( 'after_setup_theme', 'HTG_custom_header_setup' );


if ( ! function_exists( 'HTG_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 */
function HTG_header_style() {
 ...
 */ 
function HTG_header_bg_image_class() {
